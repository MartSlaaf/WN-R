      ...
      <div class="fl_l wide_column">\
        ...
        <div id="pv_your_comment" class="clear clear_fix" onclick="return cancelEvent(event);">\
          ...
          <div class="pv_comment_cont">\
            <div id="pv_reply_smile" title="' + stripHTML(getLang('photos_reply_emoji_hint')) + '" class="emoji_smile fl_l" onmouseover="if (window.Emoji) Emoji.ttOver(this);" onmouseout="if (window.Emoji) Emoji.ttOut(this);" onmousedown="return Photoview.showEmojiTT(this, event);" onclick="return cancelEvent(event);" style="right: 1px; opacity: 0.7;"><div class="emoji_smile_icon_on"></div><div class="emoji_smile_icon"></div></div>\
...
//    }
    ...
    if (listId == 'temp' && !cur.pvOptions.temp_final) {
      ...
      cur.pvSummary.innerHTML = ((count > 1) ? getLang('photos_photo_num_of_N').replace('%s', cur.pvIndex + 1).replace('%s', count) : getLang('photos_view_one_photo'));
    }
